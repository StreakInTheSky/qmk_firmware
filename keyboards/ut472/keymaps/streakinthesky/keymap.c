...
LAYOUT(
  ...
  KC_CAPS, MO(3),   KC_LALT, KC_GUI,  MO(2),      KC_SPC,        MO(1),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
LAYOUT( /* Left */
  ...
  /* FN Layer 3
   * ,-------------------------------------------------------------------------.
   * |     |     |     |     |     |     |     |PrtSc|BriUp|BriDn|Insrt| Delete|
   * |-------------------------------------------------------------------------+
   * |      |     |     |     |     |     |     |     |     |     |     |      |
   * |-------------------------------------------------------------------------+
   * |       |Vol- |Vol+ |Mute |     |     |     |     |     |     |     |     |
...
LAYOUT( /* Tab */
  _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_BRIU, KC_BRID, KC_INS,  KC_DEL, 
