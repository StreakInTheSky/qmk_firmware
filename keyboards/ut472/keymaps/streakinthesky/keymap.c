...
LAYOUT( /* Right */
  KC_GRV,  KC_UNDS, KC_PLUS, KC_MINS, KC_EQL,  _______, _______, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_BSLS,
...
LAYOUT( /* Left */
  KC_TILD, KC_UNDS, KC_PLUS, KC_MINS, KC_EQL,  _______, _______, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_PIPE,
  _______, KC_F11,  KC_F12,  KC_F13,  KC_F14,  KC_F15,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, _______,
  _______, KC_F16,  KC_F17,  KC_F18,  KC_F19,  KC_F20,  KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______,
