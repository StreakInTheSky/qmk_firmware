...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_tkl_tsangan(\
      _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______, _______,            _______, KC_BRID, KC_BRIU, \
  ...
  [2] = LAYOUT_tkl_tsangan(\ // Disables L Win Key
